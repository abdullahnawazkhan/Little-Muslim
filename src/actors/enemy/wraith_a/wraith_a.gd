...
onready var position_spell := get_node("Position2D")
const SPELL = preload("res://src/actors/enemy/wraith_a/spell/spell_wraith_a.tscn")
...
func is_stopped_death_timer() -> bool:
