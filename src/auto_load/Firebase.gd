...
var CHANGE_PASSWORD_ENDPOINT = "https://identitytoolkit.googleapis.com/v1/accounts:update?key=%s" % API_KEY
var PASSWORD_RESET_ENDPOINT = "https://identitytoolkit.googleapis.com/v1/accounts:sendOobCode?key=%s" % API_KEY
...
func change_password(password, http) -> void:
	...
	http.request(CHANGE_PASSWORD_ENDPOINT, [], false, HTTPClient.METHOD_POST, to_json(body))
...
func forgot_my_password(email, http) -> void:
	...
	http.request(PASSWORD_RESET_ENDPOINT, [], false, HTTPClient.METHOD_POST, to_json(body))
